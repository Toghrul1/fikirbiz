      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {analytics && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="bg-white rounded-lg shadow-sm p-6 border border-brand-gray/30 border-l-4 border-l-brand-gold">
              <h3 className="text-sm font-medium text-brand-khaki uppercase tracking-wider">Ümumi Müştəri</h3>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 border border-brand-gray/30 border-l-4 border-l-brand-green">
              <h3 className="text-sm font-medium text-brand-khaki uppercase tracking-wider">Bugün Qeydiyyat</h3>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 border border-brand-gray/30 border-l-4 border-l-[#3B82F6]">
              <h3 className="text-sm font-medium text-brand-khaki uppercase tracking-wider">Aktiv Session</h3>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-brand-gray/30 overflow-hidden">
          <div className="px-6 py-4 border-b border-brand-gray/30 bg-gray-50 flex justify-between items-center">
            <h2 className="text-lg font-medium text-brand-navy">Müştərilər</h2>
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-brand-khaki uppercase tracking-wider">İstifadəçi</th>
                  <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-brand-khaki uppercase tracking-wider">Qeydiyyat Tarixi</th>
                  <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-brand-khaki uppercase tracking-wider">Son Giriş</th>
                  <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-brand-khaki uppercase tracking-wider">Status</th>
                  <th scope="col" className="px-6 py-3 text-right text-xs font-medium text-brand-khaki uppercase tracking-wider">Əməliyyat</th>
                </tr>
              </thead>
              <tbody className="bg-white divide-y divide-gray-200">
                {users.map((u) => (
                  <tr key={u.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      {u.lastLoginAt ? new Date(u.lastLoginAt).toLocaleDateString() : 'Heç vaxt'}
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                      ...
                      >
                        {u.isActive ? 'Deaktiv et' : 'Bərpa et'}
                      </button>
                    </td>
                  </tr>
                ))}
