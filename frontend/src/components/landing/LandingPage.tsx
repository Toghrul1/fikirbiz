      ...
      <main className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="max-w-5xl w-full grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex justify-center">
            <div className="bg-white rounded-3xl shadow-lg p-10 flex flex-col items-center gap-6">
              {/* Logo */}
              <div className="bg-brand-navy rounded-2xl px-10 py-8 flex items-center justify-center">
              ...
              <div className="flex flex-col gap-3 w-full">
                <button
                  ...
                  className="w-full px-6 py-3 rounded-xl bg-brand-gold text-brand-navy font-semibold text-sm hover:bg-[#B8962E] transition-colors"
                >
                  FikirBiz Basic
                </button>
                <button
                  onClick={() => navigate('/login')}
                  className="w-full px-6 py-3 rounded-xl border-2 border-brand-gray/30 text-brand-navy font-semibold text-sm hover:border-brand-gold hover:bg-brand-gold/5 transition-colors"
                >
                  FikirBiz Pro
                </button>
              </div>
              ...
              <div className="flex items-center gap-3">
                <a
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-full bg-brand-navy/5 text-brand-gray hover:bg-[#E4405F] hover:text-white transition-colors"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex h-10 w-10 items-center justify-center rounded-full bg-brand-navy/5 text-brand-gray hover:bg-[#0A66C2] hover:text-white transition-colors"
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
