    ...
    <div className="min-h-screen bg-brand-ivory font-sans text-brand-navy flex flex-col">
      ...
      <header className="flex items-center justify-between px-6 py-4 border-b border-brand-gray/20 bg-white/80 backdrop-blur-md sticky top-0 z-20">
        ...
        <div className="flex items-center gap-5">
          <img src="/logo.jpg" alt="FikirBiz" className="h-10 w-auto rounded" />
          <div className="flex items-center gap-2">
            <a
              href="https://instagram.com/fikirbiz"
              target="_blank"
              rel="noopener noreferrer"
              className="flex h-8 w-8 items-center justify-center rounded-full bg-brand-navy/5 text-brand-gray hover:bg-[#E4405F] hover:text-white transition-colors"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex h-8 w-8 items-center justify-center rounded-full bg-brand-navy/5 text-brand-gray hover:bg-[#0A66C2] hover:text-white transition-colors"
            >
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="flex items-center gap-3">
          <div className="flex rounded-lg bg-brand-navy/5 p-1">
            <button
      ...
      <main className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="max-w-2xl w-full text-center">
          ...
          <div className="mb-8">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-brand-navy mb-4 leading-tight">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <button
              ...
              className="w-full sm:w-auto px-8 py-3 rounded-xl bg-brand-navy text-brand-gold font-semibold hover:bg-brand-navy/90 transition-colors shadow-lg shadow-brand-navy/20"
            >
              Giriş Edin
            </button>
            <button
              onClick={() => navigate('/register')}
              className="w-full sm:w-auto px-8 py-3 rounded-xl border-2 border-brand-navy text-brand-navy font-semibold hover:bg-brand-navy hover:text-brand-gold transition-colors"
            >
              Qeydiyyatdan Keçin
            </button>
          </div>
