    ...
    <div className="min-h-screen bg-brand-ivory font-sans text-brand-navy flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="max-w-2xl w-full text-center">
          ...
          {/* Logo + Social + Plan Selector */}
          <div className="mb-8 p-6 rounded-2xl bg-white border border-brand-gray/20 shadow-sm">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              {/* Logo + Social */}
              <div className="flex items-center gap-5">
                <img src="/logo.jpg" alt="FikirBiz" className="h-12 w-auto rounded" />
